 ...
 //  PropertyDescriptor new can raise an IntrospectionException.
   ...
   public PropertyDescriptor [] getPropertyDescriptors() {
      try {
         ...
         myProperties[67] = new PropertyDescriptor("InWsAddressV2Type", rootClass);
         myProperties[68] = new IndexedPropertyDescriptor("OutGRcWsStaffRcCodeMkRcCode", rootClass, null, null, "getOutGRcWsStaffRcCodeMkRcCode", null);
         myProperties[69] = new IndexedPropertyDescriptor("OutGRcWsStaffRcCodeAppointmentType", rootClass, null, null, "getOutGRcWsStaffRcCodeAppointmentType", null);
         myProperties[70] = new IndexedPropertyDescriptor("OutGRcDescriptionCsfStringsString60", rootClass, null, null, "getOutGRcDescriptionCsfStringsString60", null);
         myProperties[71] = new IndexedPropertyDescriptor("OutGRcAvailableBudgetIefSuppliedTotalCurrency", rootClass, null, null, "getOutGRcAvailableBudgetIefSuppliedTotalCurrency", null);
         myProperties[72] = new IndexedPropertyDescriptor("OutGRcTotalBudgetIefSuppliedTotalCurrency", rootClass, null, null, "getOutGRcTotalBudgetIefSuppliedTotalCurrency", null);
         myProperties[73] = new PropertyDescriptor("OutTotalCostIefSuppliedTotalCurrency", rootClass, "getOutTotalCostIefSuppliedTotalCurrency", null);
         myProperties[74] = new PropertyDescriptor("OutAvailableBudgetAmountIefSuppliedTotalCurrency", rootClass, "getOutAvailableBudgetAmountIefSuppliedTotalCurrency", null);
         myProperties[75] = new PropertyDescriptor("OutBudgetAmountIefSuppliedTotalCurrency", rootClass, "getOutBudgetAmountIefSuppliedTotalCurrency", null);
         myProperties[76] = new PropertyDescriptor("OutSmsCostCostPerSms", rootClass, "getOutSmsCostCostPerSms", null);
         myProperties[77] = new PropertyDescriptor("OutRcDesriptionCsfStringsString60", rootClass, "getOutRcDesriptionCsfStringsString60", null);
         myProperties[78] = new PropertyDescriptor("OutFileNameWizfuncReportingControlPathAndFilename", rootClass, "getOutFileNameWizfuncReportingControlPathAndFilename", null);
         myProperties[79] = new PropertyDescriptor("OutSendSmsCsfStringsString1", rootClass, "getOutSendSmsCsfStringsString1", null);
         myProperties[80] = new IndexedPropertyDescriptor("OutGpWsGenericCodeCode", rootClass, null, null, "getOutGpWsGenericCodeCode", null);
         myProperties[81] = new IndexedPropertyDescriptor("OutGpWsGenericCodeEngDescription", rootClass, null, null, "getOutGpWsGenericCodeEngDescription", null);
         myProperties[82] = new PropertyDescriptor("OutMagisterialCriteriaTypeCsfStringsString1", rootClass, "getOutMagisterialCriteriaTypeCsfStringsString1", null);
         myProperties[83] = new PropertyDescriptor("OutRegistrationCriteriaTypeCsfStringsString1", rootClass, "getOutRegistrationCriteriaTypeCsfStringsString1", null);
         myProperties[84] = new IndexedPropertyDescriptor("OutMagisterialGpCsfStringsString15", rootClass, null, null, "getOutMagisterialGpCsfStringsString15", null);
         myProperties[85] = new IndexedPropertyDescriptor("OutRegistrationGpCsfStringsString15", rootClass, null, null, "getOutRegistrationGpCsfStringsString15", null);
         myProperties[86] = new PropertyDescriptor("OutWsStudyUnitPeriodDetailMkAcademicYear", rootClass, "getOutWsStudyUnitPeriodDetailMkAcademicYear", null);
         myProperties[87] = new PropertyDescriptor("OutWsStudyUnitPeriodDetailMkAcademicPeriod", rootClass, "getOutWsStudyUnitPeriodDetailMkAcademicPeriod", null);
         myProperties[88] = new PropertyDescriptor("OutSecurityWsPrinterCode", rootClass, "getOutSecurityWsPrinterCode", null);
         myProperties[89] = new PropertyDescriptor("OutSecurityWsUserNumber", rootClass, "getOutSecurityWsUserNumber", null);
         myProperties[90] = new PropertyDescriptor("OutSecurityWsUserNumberOfLogonAttempts", rootClass, "getOutSecurityWsUserNumberOfLogonAttempts", null);
         myProperties[91] = new PropertyDescriptor("OutSecurityWsUserLoggedOnFlag", rootClass, "getOutSecurityWsUserLoggedOnFlag", null);
         myProperties[92] = new PropertyDescriptor("OutSecurityWsUserInUsedFlag", rootClass, "getOutSecurityWsUserInUsedFlag", null);
         myProperties[93] = new PropertyDescriptor("OutSecurityWsUserLastLogonDate", rootClass, "getOutSecurityWsUserLastLogonDate", null);
         myProperties[94] = new PropertyDescriptor("OutSecurityWsUserName", rootClass, "getOutSecurityWsUserName", null);
         myProperties[95] = new PropertyDescriptor("OutSecurityWsUserPersonnelNo", rootClass, "getOutSecurityWsUserPersonnelNo", null);
         myProperties[96] = new PropertyDescriptor("OutSecurityWsUserPhoneNumber", rootClass, "getOutSecurityWsUserPhoneNumber", null);
         myProperties[97] = new PropertyDescriptor("OutSecurityWsUserPassword", rootClass, "getOutSecurityWsUserPassword", null);
         ...
         myProperties[119] = new PropertyDescriptor("OutSmsRequestBatchNr", rootClass, "getOutSmsRequestBatchNr", null);
         myProperties[120] = new PropertyDescriptor("OutSmsRequestMkPersNr", rootClass, "getOutSmsRequestMkPersNr", null);
         myProperties[121] = new PropertyDescriptor("OutSmsRequestMkRcCode", rootClass, "getOutSmsRequestMkRcCode", null);
         myProperties[122] = new PropertyDescriptor("OutSmsRequestMkDepartmentCode", rootClass, "getOutSmsRequestMkDepartmentCode", null);
         myProperties[123] = new PropertyDescriptor("OutSmsRequestRequestTimestamp", rootClass, "getOutSmsRequestRequestTimestamp", null);
         myProperties[124] = new PropertyDescriptor("OutSmsRequestSmsMsg", rootClass, "getOutSmsRequestSmsMsg", null);
         myProperties[125] = new PropertyDescriptor("OutSmsRequestControlCellNr", rootClass, "getOutSmsRequestControlCellNr", null);
         myProperties[126] = new PropertyDescriptor("OutSmsRequestMessageCnt", rootClass, "getOutSmsRequestMessageCnt", null);
         myProperties[127] = new PropertyDescriptor("OutSmsRequestTotalCost", rootClass, "getOutSmsRequestTotalCost", null);
         myProperties[128] = new PropertyDescriptor("OutSmsRequestFromSystemGc26", rootClass, "getOutSmsRequestFromSystemGc26", null);
         myProperties[129] = new PropertyDescriptor("OutSmsRequestReasonGc27", rootClass, "getOutSmsRequestReasonGc27", null);
         myProperties[130] = new PropertyDescriptor("OutSmsRequestSelectionCriteria", rootClass, "getOutSmsRequestSelectionCriteria", null);
         myProperties[131] = new PropertyDescriptor("OutSmsRequestProgramName", rootClass, "getOutSmsRequestProgramName", null);
         myProperties[132] = new PropertyDescriptor("OutSmsRequestControlCellNr2", rootClass, "getOutSmsRequestControlCellNr2", null);
         myProperties[133] = new PropertyDescriptor("OutSmsRequestControlCellNr3", rootClass, "getOutSmsRequestControlCellNr3", null);
         myProperties[134] = new PropertyDescriptor("OutErrorFlagCsfStringsString1", rootClass, "getOutErrorFlagCsfStringsString1", null);
         myProperties[135] = new PropertyDescriptor("OutNovellCodeWsStaffEmailAddress", rootClass, "getOutNovellCodeWsStaffEmailAddress", null);
         return myProperties;
