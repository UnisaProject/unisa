...
public class DocDao extends StudentSystemDAO {
	...
	public List<Doc> getAllOptionalDocs(String studentNr,String year, String matrix, boolean stuExist) throws Exception{
		...
		//log.debug("DocDao - getAllOptionalDocs - Return Docs to List");
		return docs;
	...
	public List<Doc> getAllRequiredDocs(String studentNr, String year, String period, String required, String matrix, boolean isStuExist, String loginSelectMain) throws Exception{
		...
		try {
			...
			}else if (isStuExist || "MD".equalsIgnoreCase(loginSelectMain)){
	...
	public ArrayList<StudentFile> getAllMDRequiredDocs(String studentNr,String year, String qualCode, String specCode) throws Exception{
		...
		//log.debug("DocDao - getAllMDRequiredDocs - studentNr=" + studentNr + ", year=" + year+", qualCode="+qualCode+", specCode="+specCode);
		...
		try {
			...
			//log.debug("DocDao - getAllMDRequiredDocs - qualCode: " + qualCode + ", specCode: " + specCode);
				...
				//log.debug("DocDao - getAllMDRequiredDocs - query=" + query + ", qual="+qualCode+", spec="+specCode+", studentNr="+studentNr+", year="+year);
			...
			throw new Exception(
				"DocDao : Error reading getting M&D Required Document list / " + ex);
		} finally {
			try {
			} catch (Exception e) {
				e.printStackTrace();
	...
	public String getSTUAPQStatus(String studentNr,String acaYear, String period) throws Exception{
		...
		try{		
			...
			throw new Exception(
					"DocDAO : Error reading getting getSTUAPQStatus list / " + ex);
		} finally {
			try {
		...
		//log.debug("DocDao - getSTUAPQStatus - checkAP: " + checkAP );
		return checkAP;
	}
