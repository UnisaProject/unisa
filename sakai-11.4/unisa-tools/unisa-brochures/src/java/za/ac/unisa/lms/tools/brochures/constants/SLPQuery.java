...
public class SLPQuery {
	...
	public String mySLPQuery(String collegeCode, String schoolCode, String deptCode, int year){
		...
		stringBuilder.append(" quaslp.MK_QUALIFICATION_CODE code, quaslp.MK_ACADEMIC_YEAR year, quaslp.TARGET_GROUP,"); stringBuilder.append(" quaslp.ADMISSION_REQUIREMENTS adminReq, quaslp.DURATION duration,");
		...
		stringBuilder.append(" GRD.PURPOSE purposeStatement");
