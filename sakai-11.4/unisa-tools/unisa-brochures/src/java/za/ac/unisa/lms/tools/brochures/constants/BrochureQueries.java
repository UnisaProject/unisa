...
public class BrochureQueries {
	...
	public String myModuleQuery(String colCode, String schCode, String dptCode,
		...
		sb.append(" (SELECT LISTAGG(MK_TAL_CODE || '.' || OTHER_LANGUAGE_DESCRIPTION, ',') WITHIN GROUP (ORDER BY mk_tal_code) FROM sunpdtlang WHERE fk_suncode = sunpdt.fk_suncode AND fk_academic_year = sunpdt.MK_ACADEMIC_YEAR AND fk_semester_period IN (0, 1)) LANG,"); 
