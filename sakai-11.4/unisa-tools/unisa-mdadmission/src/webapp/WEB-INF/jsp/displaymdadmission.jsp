...
<script language="javascript">
    ...
    <sakai:group_heading><fmt:message key="page.heading.studdetails"/></sakai:group_heading>
		...
		<sakai:group_table>
		  	<logic:notEmpty name="mdAdmissionForm" property="documentList">
				...
				%>
				<tr>
				  <td><html:link href="displaymdadmission.do?act=getFile" name="params"><bean:write name="uFile" property="displayName"/></html:link></td>
				</tr>
				<!--  
				<tr>
	...
	<sakai:flat_list>
		...
		<sakai:actions>			
			...
			<!--<html:submit property="act"><fmt:message key="button.signoff"/></html:submit>-->
