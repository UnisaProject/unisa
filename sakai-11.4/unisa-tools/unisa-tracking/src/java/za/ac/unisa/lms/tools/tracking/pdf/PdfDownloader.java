...
public class PdfDownloader {
	...
	public void processPDFRequest(String pdfPath, String pdfFileName, HttpServletResponse response) throws IOException{
                ...
                File pdfFile = new File(pdfPath+"/"+pdfFileName+".pdf");
                
                if (!pdfFile.exists()) {
                	//log.debug("PdfDownloader - processPDFRequest - File not Found - pdfFile="+pdfPath+"/"+pdfFileName+".pdf");
        			response.sendError(HttpServletResponse.SC_NOT_FOUND);
        			return;
        		}
                //log.debug("PdfDownloader - processPDFRequest - File Found - pdfFile="+pdfPath+"/"+pdfFileName+".pdf");
