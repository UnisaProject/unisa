...
<html:form action="/applyForStudentNumber">
	<html:hidden property="page" value="applyNewAddress2"/>
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">	
					<table>
						<tr>
							<td colspan="2">&nbsp;<strong><fmt:message key="page.physical"/></strong></td>
						</tr><tr>
							...
							<td style="width:50%;">
								<table>
									<tr>
										<td colspan="2"><html:text name="studentRegistrationForm" property="student.physicalAddress.line1" maxlength="28" size="50"/></td>
									</tr><tr>
										<td colspan="2"><font size="1">&nbsp;</font></td>
									</tr><tr>
										<td colspan="2"><html:text name="studentRegistrationForm" property="student.physicalAddress.line2" maxlength="28" size="50"/></td>
									</tr><tr>
										<td colspan="2"><font size="1">&nbsp;</font></td>
									</tr><tr>
										<td colspan="2"><html:text name="studentRegistrationForm" property="student.physicalAddress.line3" maxlength="28" size="50"/></td>
									</tr><tr>
										<td colspan="2"><font size="1">&nbsp;</font></td>
									</tr><tr>
										<td colspan="2"><html:text name="studentRegistrationForm" property="student.physicalAddress.line4" maxlength="28" size="50"/></td>
									</tr><tr>
										<td colspan="2"><font size="1">&nbsp;</font></td>
									</tr><tr>
										<td colspan="2"><html:text name="studentRegistrationForm" property="student.physicalAddress.line5" maxlength="28" size="50"/></td>
									</tr><tr>
										<td colspan="2"><font size="1">&nbsp;</font></td>
									</tr><tr>
										<td colspan="2"><html:text name="studentRegistrationForm" property="student.physicalAddress.line6" maxlength="28" size="50"/></td>
									</tr><tr>
										<td colspan="2"><font size="1">&nbsp;</font></td>
									</tr>
									<!-- 
									<logic:notEqual name="studentRegistrationForm" property="addressSubResultPhys" value="">
										<tr>
											<td colspan="2">
												<strong><font color="red"><fmt:message key="page.useSuburb"/>&nbsp;
												<bean:write name='studentRegistrationForm' property='addressSubResultPhys'/></font></strong>
											</td>
										</tr><tr>
											<td colspan="2"><font size="1">&nbsp;</font></td>
										</tr>
									 ...
									 -->
									<tr>
										<td style="width:100px">&nbsp;<fmt:message key="page.postalcode"/>&nbsp;</td>
										<td align="right"><html:text name="studentRegistrationForm" property="student.physicalAddress.areaCode" maxlength="4" size="10" readonly="true" />
											<html:submit property="action.search2"><fmt:message key="button.searchPostalcode"/></html:submit>
										</td>
									</tr>
								</table>
							</td>
							<td id="infoBox" style="width:50%">
								<div id="divTop"><i><fmt:message key="page.physadrinfo"/></i></div>
