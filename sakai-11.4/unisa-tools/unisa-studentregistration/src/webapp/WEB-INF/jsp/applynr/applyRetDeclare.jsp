...
<head>
	...
	window.onunload=function() { void(0) }  
		...
		function doAction() {
			...
			//	return false;
			//}else{
				document.studentRegistrationForm.action = 'applyForStudentNumber.do?act=applyRetDeclare';  
...
<html:form action="/applyForStudentNumber">
	<html:hidden property="page" value="applyRetDeclare"/>
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">	
					<sakai:group_table>
						<tr>
				 			<td colspan="2"><strong><fmt:message key="page.studentnr.apply.declare"/></strong></td>
						</tr><tr>
							<td colspan="2">
								...
								<fmt:message key="page.studentnr.apply.declare.text3b"/>
							</td>
						</tr><tr>
							<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<html:radio  property ="agree" value="Y"/>&nbsp;<fmt:message key="page.agree"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<html:radio property ="agree" value="N"/>&nbsp;<fmt:message key="page.disagree"/>
							</td>
						</tr><tr>
							<td colspan="2">Click only once on the Submit button</td>
						</tr>
					</sakai:group_table>
				</div>
