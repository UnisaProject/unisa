...
<html:form action="/applyForStudentNumber">
	<html:hidden property="page" value="applyNewAddress1"/>
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">	
					<table>
						<tr>
							<td colspan="2">&nbsp;<strong><fmt:message key="page.postal"/></strong></td>
						</tr><tr>
							<td colspan="2"><font size="1">&nbsp;</font></td>
						</tr><tr>
							<td colspan="2">&nbsp;<fmt:message key="page.country"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<span>
							...
							<td style="width:50%;">
								<table>
									<tr>
										<td colspan="2"><html:text name="studentRegistrationForm" property="student.postalAddress.line1" maxlength="28" size="50"/></td>
									</tr><tr>
										<td colspan="2"><font size="1">&nbsp;</font></td>
									</tr><tr>
										<td colspan="2"><html:text name="studentRegistrationForm" property="student.postalAddress.line2" maxlength="28" size="50"/></td>
									</tr><tr>
										<td colspan="2"><font size="1">&nbsp;</font></td>
									</tr><tr>
										<td colspan="2"><html:text name="studentRegistrationForm" property="student.postalAddress.line3" maxlength="28" size="50"/></td>
									</tr><tr>
										<td colspan="2"><font size="1">&nbsp;</font></td>
									</tr><tr>
										<td colspan="2"><html:text name="studentRegistrationForm" property="student.postalAddress.line4" maxlength="28" size="50"/></td>
									</tr><tr>
										<td colspan="2"><font size="1">&nbsp;</font></td>
									</tr><tr>
										<td colspan="2"><html:text name="studentRegistrationForm" property="student.postalAddress.line5"  maxlength="28" size="50"/></td>
									</tr><tr>
										<td colspan="2"><font size="1">&nbsp;</font></td>
									</tr><tr>
										<td colspan="2"><html:text name="studentRegistrationForm" property="student.postalAddress.line6"  maxlength="28" size="50"/></td>
									</tr><tr>
										<td colspan="2"><font size="1">&nbsp;</font></td>
									</tr>
									<!-- 
									<logic:notEqual name="studentRegistrationForm" property="addressSubResultPos" value="">
										<tr>
											<td colspan="2">
												<strong><font color="red"><fmt:message key="page.useSuburb"/>&nbsp;
												<bean:write name='studentRegistrationForm' property='addressSubResultPos'/></font></strong>
											</td>
										</tr><tr>
											<td colspan="2"><font size="1">&nbsp;</font></td>
										</tr>
									...
									<tr>
										...
										<td align="right"><html:text name="studentRegistrationForm" property="student.postalAddress.areaCode" maxlength="4" size="10" readonly="true" />
											<html:submit property="action.search1"><fmt:message key="button.searchPostalcode"/></html:submit>
										</td>
									</tr>
								</table>
							</td>
