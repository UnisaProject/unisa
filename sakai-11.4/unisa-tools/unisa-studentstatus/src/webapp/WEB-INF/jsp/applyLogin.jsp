...
<sakai:html>
	...
	function doSubmit(button){
		if (button === "Continue"){
			document.studentStatusForm.action='studentStatus.do?act=applyLogin';
		}else if (button === "Back"){
			document.studentStatusForm.action='studentStatus.do?act=back';
		}else if (button === "Cancel"){
			//document.studentStatusForm.action='studentStatus.do?act=cancel';
			//var url = "/unisa-studentregistration/applyForStudentNumber.do?act=stepLoginSelect;
...
<html:form action="/studentStatus">
	...
	<input type="hidden" name="webOpenDate" id="webOpenDate" value="<bean:write name='studentStatusForm' property='student.webOpenDate' />"/>
	<input type="hidden" name="allowLogin" id="allowLogin" value="<bean:write name='studentStatusForm' property='allowLogin'/>"/>
	<input type="hidden" name="webLogMsg" id="webLogMsg" value="<bean:write name='studentStatusForm' property='webLoginMsg'/>"/>
						...
						<table style="width:100%;">
			               	<logic:equal name="studentStatusForm" property="allowLogin" value="true">
					               	<tr>
						              	...
						              	<td style="height:30px"><html:text name="studentStatusForm" property="student.number" maxlength="8" size="24" onfocus="this.select();" />&nbsp;</td>
						            </tr><tr>
					              		<td style="width:180px;height:30px" valign="top"><fmt:message key="page.login.studsurname"/></td>
					              		<td valign="bottom"><html:text name="studentStatusForm" property="student.surname" maxlength="28" size="24"/>&nbsp;</td>
					            	</tr><tr>
					              		<td style="width:180px;height:30px" valign="top"><fmt:message key="page.login.studfullname"/></td>
					              		<td valign="bottom"><html:text name="studentStatusForm" property="student.firstnames" maxlength="60" size="24" onfocus="this.select();" />&nbsp;</td>
					            	</tr><tr>
					            		...
					            		<td valign="bottom">
							              	<table style="width:100%">
							              		...
							              		<tr>
							              			<td>
							              				<html:select name="studentStatusForm" property="student.birthYear">
										 					<html:options collection="yearlist" property="value" labelProperty="label"/>
														</html:select>
													</td>
													<td>
							              				<html:select name="studentStatusForm" property="student.birthMonth">
										 					<html:options collection="monthlist" property="value" labelProperty="label"/>
														</html:select>
													</td>
													<td>
							              				<html:select name="studentStatusForm" property="student.birthDay">
							...
							<logic:equal name="studentStatusForm" property="allowLogin" value="false">
								<tr>
