...
<head>
	...
	<script type="text/javascript">  
		...
		$(document).ready(function() {
	 	...
	 	function validateSelect() {
			...
			if (isSet1 === false && isSet2 === false){
				...
				if (radioSelected1 == "N"){
					showModal("Confirmation", "You have declined the offer for "+qualCode1+". Click 'OK' to confirm that you want to decline your application for this period. Click on 'Cancel' to change your selection.");
				}
				if (radioSelected2 == "Y"){
				...
				if (radioSelected2 == "N"){
					showModal("Confirmation", "You have declined the offer for "+qualCode2+". Click 'OK' to confirm that you want to decline your application for this period. Click on 'Cancel' to change your selection. ");
				}
			}
		}	 	
		...
		function doSubmit(button){
			if (button === "Continue"){
				document.studentOfferForm.action='studentOffer.do?act=applyOfferOne';
			}else if (button === "Back"){
